...
3. [Embedding Our Dataset](03-embeddings-dataset.md) - Generating embeddings for the FAQ dataset
4. [Vector Search](04-vector-search.md) - Vector search with numpy
5. [Vector Search with minsearch](05-minsearch-vector.md) - In-memory vector search
6. [RAG with Vector Search](06-rag-vector.md) - Replacing keyword search with vector search in our RAG pipeline
7. [Vector Search with sqlitesearch](07-sqlitesearch-vector.md) - Persistent vector search backed by SQLite
8. [Vector Search with PGVector](08-pgvector.md) - Production vector search with PostgreSQL and pgvector
9. [ONNX Embedder](09-onnx-embedder.md) (Optional) - Using ONNX Runtime instead of PyTorch for embeddings
10. [Next Steps](10-next-steps.md) - When to use vector search and what's next
